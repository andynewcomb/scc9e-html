...
my $baseXMLfile = "ranges_math_moorescc9e-ch12.xml"; #-------------------------> identify digfir XML file here
...
# figures (unnumbered)
$xml_contents =~ s/(<figure[^>]*block_type="UN-FIGURE"[^>]*)(>.*?<image[^>]*src="[^"]*\/([^"]*)\.jpg")/$1 data-href="figure_${chapter}_$3.html"$2/gs;
